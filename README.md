...
- To develop this, I primarily used the Next.js App Router guide, along with some additional searches to figure out the Route Handler. Based on the searches I did, I think the implementation in [app/roll-button.tsx](app/roll-button.tsx) is correct for calling the route handler, but I am somewhat unsure of that as I don't think the documentation made it very clear how that should be called (Unless I missed it by skimming).
